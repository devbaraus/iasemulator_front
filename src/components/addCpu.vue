            ...
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <div class="col">
                            ...
                            <div>
                                <div>
                                    <button @click="initProg()" class="btn btn-secondary">START</button>
                                    <button @click="stopProg()" class="btn btn-danger">STOP</button>
                                    <button @click="allocMem()" class="btn btn-danger">ALLOC</button>
                                </div>
                                <button @click="saveEg()" class="btn btn-warning">Guardar Exemplo</button>
                            </div>
                        </div>
                        <div class="col">
                            <form action>
                ...
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col">
                            <p class>
                                <i class="fas fa-microchip"></i> REGISTRADORES
                            </p>
                            <hr>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <!--<span class="input-group-text" id="labele">Equal</span>-->
                                    <!--</div>-->
                                    <!--<input type="text" id="re" class="form-control" placeholder="0000 0000"-->
                                    <!--disabled aria-label="0000 0000" aria-describedby="labelmbr">-->
                                    <!--</div>-->
                                    <!--<div class="input-group mb-3">-->
                                    <!--<div class="input-group-prepend">-->
                                    <!--<span class="input-group-text" id="labelg">Greater</span>-->
                                    <!--</div>-->
                                    <!--<input type="text" id="rg" class="form-control" placeholder="0000 0000"-->
                                    <!--disabled aria-label="0000 0000" aria-describedby="labelmbr">-->
                                    <!--</div>-->
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col">
                                    <!--<div class="input-group mb-3">-->
                                    <!--<div class="input-group-prepend">-->
                                    <!--<span class="input-group-text" id="labell">Lower</span>-->
                                    <!--</div>-->
                                    <!--<input type="text" id="rl" class="form-control" placeholder="0000 0000"-->
                                    <!--disabled aria-label="0000 0000" aria-describedby="labelmbr">-->
                                    <!--</div>-->
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
...
<script>
    import "@/components/cpujs/cpu.js";
    import "@/components/cpujs/memory.js";
    ...
    export default {
        ...
        methods: {
            saveEg(){
              console.log(this.minemonico.replace("\n", ""), this.description)
            },
            initCPU() {
                this.cp1 = new CPU();
            },
